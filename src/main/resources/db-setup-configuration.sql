...
CREATE USER 'recipe_dev_user'@'localhost' IDENTIFIED BY 'guru';
CREATE USER 'recipe_prod_user'@'localhost' IDENTIFIED BY 'guru';
CREATE USER 'recipe_dev_user'@'%' IDENTIFIED BY 'guru';
CREATE USER 'recipe_prod_user'@'%' IDENTIFIED BY 'guru';
